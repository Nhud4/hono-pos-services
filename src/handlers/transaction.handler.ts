...
export const getOrder = async (c: Context) => {
  try {
    ...
    return c.json(successResponse(data, 'Order retrieved successfully', 200), 200);
  } catch (error) {
    console.log(error);
...
export const createOrder = async (c: Context) => {
  try {
    ...
    return c.json(successResponse(data, 'Order created successfully', 201), 201);
  } catch (error) {
    console.log(error);
    return c.json(errorResponse('Internal server error', 500), 500);
  }
...
export const listTransaction = async (c: Context) => {
  try {
    ...
    return c.json(successResponse(data, 'Order retrieved successfully', 200, meta), 200);
  } catch (error) {
    console.log(error);
    return c.json(errorResponse('Internal server error', 500), 500);
  }
...
export const updateTransaction = async (c: Context) => {
  try {
    ...
    return c.json(successResponse(data, 'Order update successfully', 201), 201);
  } catch (error) {
    console.log(error);
    return c.json(errorResponse('Internal server error', 500), 500);
  }
...
export const deleteTransaction = async (c: Context) => {
  try {
    ...
    return c.json(successResponse(data, 'Order delete successfully', 201), 201);
  } catch (error) {
    console.log(error);
    return c.json(errorResponse('Internal server error', 500), 500);
  }
